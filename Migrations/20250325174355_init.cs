        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsForgotten = table.Column<bool>(type: "bit", nullable: false),
                    ForgottenDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ForgottenById = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Users_ForgottenById",
                        column: x => x.ForgottenById,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ForgottenById",
                table: "Users",
                column: "ForgottenById");
